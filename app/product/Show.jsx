      ...
      <div>
        <div className="sm:flex">
          ...
          <section className="grid sm:block justify-center">
            <img
              className="object-cover hover:bg-primary transition duration-300 cursor-zoom-in
            ...
            <div className="flex ml-2 sm:ml-0">
              {product.image.map((e, i) => (
                <img
                  ...
                  transition duration-200 hover:bg-primary rounded-xl w-auto"
          ...
          >
            ...
            >
              <img
                id="img"
                alt="img"
                className="object-cover hover:bg-primary transition duration-300
              h-64 w-64 lg:h-96 lg:w-96 bg-lightDim1 sm:rounded-2xl"
                src={urlFor(product.image && product.image[photoIndex])}
              />
            </div>
            ...
            <div className="ml-2">
              ...
              <div className="flex">
                ...
                <div className="w-40 ring-lightGray flex justify-center items-center ring-1 ml-4 px-4">
                  <span
            ...
            <div className="sm:flex w-full gap-4 mt-8 px-1">
              ...
              <button
                className="text-center hover:scale-105 transition shadow-md cursor-pointer
                 text-xl px-8 py-2 text-highLight ring-1 ring-primary"
              >
                Buy Now
              </button>
            </div>
        ...
        {/* ✅ Horizontal list flow Right→Left */}
        <Marquee products={products} direction="right-to-left" />
      </div>
    </div>
  );
};
